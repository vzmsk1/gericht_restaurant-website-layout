(() => {
    ...
    (() => {
        ...
        function initSliders() {
                ...
                on: {
                    init: function() {
                        ...
                        bullets.forEach(((bullet, index) => {
                            ...
                            bullet.innerHTML = `${number}${index + 1}`;
                        }));
                    }
                }
            });
            if (document.querySelector(".quotes-mainpage__slider")) new core(".quotes-mainpage__slider", {
            ...
            if (document.querySelector(".gallery-mainpage__slider")) new core(".gallery-mainpage__slider", {
        ...
        window.addEventListener("load", (function(e) {
            ...
            picker.setDate(new Date(2021, -1, 5), true);
            document.addEventListener("click", documentActions);
            function documentActions(e) {
                const targetElement = e.target;
                const videoModule = document.querySelector(".video-module");
                if (videoModule) if (targetElement.closest(".mainpage__video")) {
